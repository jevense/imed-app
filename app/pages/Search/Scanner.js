        ...
        <View style={styles.header}>
            ...
            >
                <Image style={{width: 30, height: 30, marginBottom: 5}}
                       source={require('../../assets/resource/ic_back_white.png')}/>
...
const ScannerPromptTitle = () => {
    return (
        <View style={{marginTop: 30, flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
            <Image style={{width: 22, height: 22}} source={require('../../assets/resource/ic_scan_gray.png')}/>
            <Text style={{color: '#fff', fontSize: 18}}>请将二维码放入圈内</Text>
        </View>
    )
}
        ...
        return (
            <View style={{marginTop: 30, alignSelf: 'center'}}>
                <Image
                    ...
                    source={require('../../assets/resource/img_scan_area.png')}
                >
                    <Animated.Image
                        style={[styles.scanLine, {top: positionY}]}
                        source={require('../../assets/resource/img_scan_line.png')}
                        resizeMode="contain"
                    />
                </Image>
            </View>
